...
\makecomment[yshift=-20pt]{comma}{カンマの後に空白を入れましょう}
...
\begin{itemize}
	\item $u = x^2 - y^2$,@\usecomment{comma}@$v = x^2-y^2$
	\item $u =\log \sqrt{x^2+y^2} = \log r$,@\usecomment{comma}@$v= \tan ^{-1} \frac{y}{x} = \theta $
